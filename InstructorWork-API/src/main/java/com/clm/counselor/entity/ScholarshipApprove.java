...
@TableName("scholarship_approve")
@ApiModel(value="ScholarshipApprove对象", description="")
public class ScholarshipApprove implements Serializable {
    ...
    @ApiModelProperty(value = "奖学金申请表ID")
